    ...
    return (
        <div className='w-full py-4 h-full'>
            ...
            <div
                ...
                <p
                    className={`flex items-center justify-center ${!isDragging && image ? 'w-1/2' : 'w-full'}`}
                    onClick={() => uploaderInput.current?.click()}>
                    {isDragging ? 'تصویر خود را اینجا رها کنید' : image ? 'آپدیت عکس جدید' : 'افزودن عکس جدید'}
                </p>
                {!isDragging && image && (
            ...
            <div className='flex flex-col justify-between gap-3'>
                <p className='text-xs font-semibold text-gray-600'>
                    برای افزودن عکس روی کادر بالا کلیک کنید و یا عکس خود را داخل کادر بالا به صورت Drag & Drop رها کنید.
                </p>
                <p className='text-xs font-semibold text-gray-600'>
